...
এই রিপোতে শেখানোর জন্য তৈরি করা কিছু প্র্যাক্টিস প্রজেক্ট আছে। প্রতিটা প্রজেক্ট আলাদা আলাদা branch এ রাখা হয়েছে যাতে সব গুছিয়ে থাকে।
...
প্রথমে রিপো clone করুন:

```bash
git clone https://github.com/akr4m/ic-learning-projects.git
cd ic-learning-projects
```

সব branch locally আনতে:

```bash
git fetch --all
```

এবার যেকোনো branch এ switch করুন:

```bash
git checkout branch-name
```

**উদাহরণ:** User Registration প্রজেক্ট দেখতে চাইলে:

```bash
git checkout 01-user-registration-system
```

সব branch এর লিস্ট দেখতে:
